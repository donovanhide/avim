...
ssh_user       = "donny@availableimagination.com"
document_root  = "/var/www/availableimagination.com/"
...
task :rsync do
  ...
  ok_failed system("rsync -avz --delete --rsh='ssh -p30300' #{public_dir}/ #{ssh_user}:#{document_root}")
end
